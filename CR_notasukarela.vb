...
Public Class CR_notasukarela
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FPPKK.CR_notasukarela.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_notasukarela
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_notasukarela = New CR_notasukarela()
        rpt.Site = Me.Site
        Return rpt
    End Function
