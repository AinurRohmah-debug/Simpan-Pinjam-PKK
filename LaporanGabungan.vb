...
Public Class LaporanGabungan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FPPKK.LaporanGabungan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanGabungan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanGabungan = New LaporanGabungan()
        rpt.Site = Me.Site
        Return rpt
    End Function
